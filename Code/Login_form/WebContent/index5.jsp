...
<body> 
<form action="http://localhost:8080/Sample2/index1.html" method="post">  
...
<div style="position: relative; left:50px; top:100px;">
    ...
    <label style="font-family: 'Lucida Console', Times, serif; font-weight: bold; font-size: 30px; " >You Are Not Registered with <%=phone %>! </label>
    <label style="font-family: 'Lucida Console', Times, serif; font-weight: bold; font-size: 30px; " > Please Register. </label>
    

</div>
<div style="position: relative; left:600px; top:100px; height: 65px; width:160px;">

    <button class="button" type="submit" style="vertical-align:middle"><span>Register </span></button>
